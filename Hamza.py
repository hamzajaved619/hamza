...
def logo():
    os.system("clear")
    print(f"""
{red}db   db  .d8b.  .88b  d88. d88888D  .d8b.  
{yellow}88   88 d8' `8b 88'YbdP`88 YP  d8' d8' `8b 
{green}88ooo88 88ooo88 88  88  88    d8'  88ooo88 
{blue}88~~~88 88~~~88 88  88  88   d8'   88~~~88 
{orange}88   88 88   88 88  88  88  d8' db 88   88 
{white}YP   YP YP   YP YP  YP  YP d88888P YP   YP
-------------------------------------------------
Owner            :           Hamza Javed
Github           :           Soon       
version          :           0.69.091
